...
({
	{
		...
		icon = "__Armored-train-renai__/assets/radar-platform-mk1/radar-platform-mk1-icon.png",
...
l_radar_platform_mk1.icon = "__Armored-train-renai__/assets/radar-platform-mk1/radar-platform-mk1-icon.png"
	...
	{
		{
			...
			filenames =
			{
				"__Armored-train-renai__/assets/radar-platform-mk1/sprites/platform-mk1-01.png",
				"__Armored-train-renai__/assets/radar-platform-mk1/sprites/platform-mk1-02.png",
				"__Armored-train-renai__/assets/radar-platform-mk1/sprites/platform-mk1-03.png",
				"__Armored-train-renai__/assets/radar-platform-mk1/sprites/platform-mk1-04.png"
			}
		},
		--DECORATIVES
		{
			...
			filenames =
			{
				"__Armored-train-renai__/assets/radar-mk1/sprites/radar-mk1-01.png",
				"__Armored-train-renai__/assets/radar-mk1/sprites/radar-mk1-02.png",
				"__Armored-train-renai__/assets/radar-mk1/sprites/radar-mk1-03.png",
				"__Armored-train-renai__/assets/radar-mk1/sprites/radar-mk1-04.png",
			}
		}
	}
}
...
{
	filename = "__Armored-train-renai__/assets/radar-platform-mk1/radar-platform-mk1-minimap-representation.png",
	flags = {"icon"},
	size = {20, 40},
	scale = 0.5
}
...
{
	filename = "__Armored-train-renai__/assets/radar-platform-mk1/radar-platform-mk1-selected-minimap-representation.png",
	flags = {"icon"},
	size = {20, 40},
	scale = 0.5
}
